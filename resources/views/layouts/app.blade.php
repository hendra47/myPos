...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="#" class="logo">
                <span class="logo-mini"><b>TOKO</b></span>
                <span class="logo-lg"><b>ASHAR</b> WHEELS</span>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a class="btn btn-default btn-flat" href="{{ route('user.profil') }}">Edit
                                            Profil</a>
                                    </div>
      ...
      Aplikasi POS oleh: Rohi Abdulloh
            ...
            <strong>Copyright &copy; 2019 <a href="#">TOKO ASHAR WHEELS</a>.</strong> All rights reserved.
        </footer>
        <!-- End Footer -->
